...
from .constants import AGE_GROUPS, EMOTION_RU, EMOTIONS, GENDERS, LANGUAGES
...
class EmotionMappingDialog(QDialog):
    def __init__(self, infos, parent=None):
        ...
        for row, info in enumerate(infos):
            ...
            self.table.setItem(row, 0, QTableWidgetItem(info.label))
            ...
            if info.suggested:
                combo.setCurrentIndex(EMOTIONS.index(info.suggested) + 1)
